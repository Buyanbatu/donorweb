...
use App\Hereglesen_tstsb_tasagaar;
use Illuminate\Http\Request;
use Carbon\Carbon;
use Lang;
use Sentinel;

class Hereglesen_tstsb_tasagaarsController extends Controller {
	...
	{
		$hereglesen_tstsb_tasagaar = Hereglesen_tstsb_tasagaar::where('id', '1')->get();

		foreach($hereglesen_tstsb_tasagaar as $t){
	...
	{
		return view('admin.hereglesen_tstsb_tasagaars.create');
	}
	...
	public function store(Request $request)
	{
		...
		$result = new Hereglesen_tstsb_tasagaar($request->except('buheltsus',
								   'ulaanesutguruuleg',
								   'darshilsanulaanes',
								   'ugaasanulaanes',
								   'tsagaanesguibuheltsus',
		...
		return redirect('admin/hereglesen_tstsb_tasagaars')->with('success', Lang::get('message.success.create'));
	}
	...
	{
		$hereglesen_tstsb_tasagaar = Hereglesen_tstsb_tasagaar::findOrFail($id);
		return view('admin.hereglesen_tstsb_tasagaars.show', compact('hereglesen_tstsb_tasagaar'));
	}
	...
	{
		$hereglesen_tstsb_tasagaar = Hereglesen_tstsb_tasagaar::findOrFail($id);
		return view('admin.hereglesen_tstsb_tasagaars.edit', compact('hereglesen_tstsb_tasagaar'));
	}
	...
	public function update($id, Request $request)
	{
		...
		$hereglesen_tstsb_tasagaar = Hereglesen_tstsb_tasagaar::findOrFail($id);
		$hereglesen_tstsb_tasagaar->update($request->all());
		return redirect('admin/hereglesen_tstsb_tasagaars')->with('success', Lang::get('message.success.update'));
	}

	/**
    	 * Delete confirmation for the given Hereglesen_tstsb_tasagaar.
    	 *
    	 * @param  int      $id
    	 * @return View
    	 */
    	public function getModalDelete($id = null)
    	{
            $error = '';
            $model = '';
            $confirm_route =  route('admin.hereglesen_tstsb_tasagaars.delete',['id'=>$id]);
            return View('admin/layouts/modal_confirmation', compact('error','model', 'confirm_route'));

    	}

    	/**
    	 * Delete the given Hereglesen_tstsb_tasagaar.
    	 *
    	 * @param  int      $id
    	 * @return Redirect
    	 */
    	...
    	{
    		$hereglesen_tstsb_tasagaar = Hereglesen_tstsb_tasagaar::destroy($id);

            // Redirect to the group management page
            return redirect('admin/hereglesen_tstsb_tasagaars')->with('success', Lang::get('message.success.delete'));
