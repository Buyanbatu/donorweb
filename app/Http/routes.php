...
Route::group(array('prefix' => 'admin', 'middleware' => ['SentinelAdmin', 'SentinelSalbar']), function () {
    # Dashboard / Index
...
Route::get('news_item/{slug?}', 'NewsController@getNewsFrontend');
Route::post('news_item/{news}/comment', 'NewsController@storeCommentFrontend');

Route::get('page', array('as' => 'page', 'uses' => 'PagesController@getIndexFrontend'));
Route::get('blog/{slug}/tag', 'BlogController@getBlogTagFrontend');
Route::get('{slug?}', 'PagesController@getPageFrontend');
Route::post('blogitem/{blog}/comment', 'BlogController@storeCommentFrontend');
