                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form action="{{ route('signin') }}" autocomplete="on" method="post" role="form">
                                ...
                                <div class="form-group {{ $errors->first('email', 'has-error') }}">
                                    ...
                                    <input id="email" name="email" required type="email" placeholder="И-мэйл хаяг"
                                           value="{!! old('email') !!}"/>
                                    <div class="col-sm-12">
                                ...
                                <div class="form-group {{ $errors->first('password', 'has-error') }}">
                                    ...
                                    <input id="password" name="password" required type="password" placeholder="Жишээ нь: X8df!90EO" />
                                    <div class="col-sm-12">
                                ...
                                <p class="change_link">
                                    <a href="#toforgot">
                                        <button type="button" class="btn btn-responsive botton-alignment btn-warning btn-sm">Нууц үгээ мартсан</button>
                                    </a>
                        ...
                        <div id="forgot" class="animate form">
                            <form action="{{ route('forgot-password') }}" autocomplete="on" method="post" role="form">
                                <h3 class="black_bg">
                                    <img src="{{ asset('assets/img/logo.png') }}" alt="josh logo"><br>Нууц үг солих</h3>
                                <p>
                                    И-мэйл хаягаа доор оруулна уу бид нууц үг сэргээх линк явуулах болно.
                                </p>
                                ...
                                <p class="login button">
                                    <input type="submit" value="Илгээх" class="btn btn-success" />
                                </p>
                                <p class="change_link">
                                    <a href="#tologin" class="to_register">
                                        <button type="button" class="btn btn-responsive botton-alignment btn-warning btn-sm">Буцах</button>
                                    </a>
                                </p>
                            </form>
                        </div>
