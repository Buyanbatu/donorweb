...
{{-- Page title --}}
@section('title')
hereglesen_tstsb_tasagaars List
@parent
@stop
        ...
        <div class="panel panel-primary ">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    <a href="{{ route('admin.hereglesen_tstsb_tasagaars.create') }}" class="btn btn-sm btn-default"><span class="glyphicon glyphicon-plus"></span> @lang('button.create')</a>
                </div>
            </div>
            <br />
            <div class="panel-body">
                ...
                <table class="table table-striped table-bordered" id="table2">
                                    ...
                                    <tr>
                                        ...
                                        <th align="center" width="8%" colspan="2"><small>Дүн</small></th>
