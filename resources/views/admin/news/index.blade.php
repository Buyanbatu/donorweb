...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">@lang('news/title.news')</li>
    </ol>
</section>
                    ...
                    @if(!empty($news))
                        @foreach ($news as $ne)
                            <tr>
                                <td>{{ $ne->id }}</td>
                                <td>{{ $ne->title }}</td>
                                <td>{{ $ne->comments->count() }}</td>
                                <td>{{ $ne->created_at->diffForHumans() }}</td>
                                <td>
                                    <a href="{{ URL::to('admin/news/' . $ne->id . '/show' ) }}"><i class="livicon"
                                                                                                     data-name="info"
                                                                                                     data-size="18"
                                                                                                     data-loop="true"
                                                                                                     data-c="#428BCA"
                                    ...
                                    <a href="{{ URL::to('admin/news/' . $ne->id . '/edit' ) }}"><i class="livicon"
                                                                                                     data-name="edit"
                                                                                                     data-size="18"
                                                                                                     data-loop="true"
                                                                                                     data-c="#428BCA"
                                    ...
                                    <a href="{{ route('confirm-delete/news', $ne->id) }}" data-toggle="modal"
