                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    {!! Form::open(['route' => 'messages.store']) !!}
                                        ...
                                        <label class="col-xs-2 hidden-xs" for="subject">Hen ruu:</label>
                                        <select id="multiple-user" class="col-xs-9 multiple-user" multiple="multiple">
                                        ...
                                        <div class="clear"></div>
                                        @endif
                                        <label class="col-xs-2 hidden-xs" for="subject">Garchig:</label>
                                        <input type="text" class="col-xs-9" id="subject" tabindex="1" placeholder="Subject">
                                        <div class="clear"></div>
                                        <div class='box-body pad col-sm-12'>
                                            
                                                <div id="summernote" name="message"></div>
